...
file = r'C:\Users\user\Desktop\ex.wav'
...
def ogg2wav():
    d,r = librosa.load(file_ogg)
    scipy.io.wavfile.write(file_wav,r,d)
...
def voice_processing(update):
	...
	with sr.AudioFile(file_ogg) as source:
		try:
	...
	while True:
		...
		try:
			...
			if update_id == update["update_id"]:
				...
				elif get_message_text(update).lower() == "specialist" or voice_handler(update) == 'specialist':
				...
				elif get_message_text(update).lower() in name:
